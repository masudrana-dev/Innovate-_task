            ...
            <Container>
                <Zoom damping={0.1}>
                    <div className="flex-col  md:flex md:flex-row justify-between items-center">
                        <div className=" flex sm:flex-col md:flex-row justify-between items-center md:gap-5 lg:gap-20">
                            <div >
                                {/* Photo 1 */}
                                ...
                                {/* Photo-2  */}
                                <div className="relative  md:mt-[77px] md:ml-[85px] sm:mb-10 ">
                                    <div className="w-[160px] h-[170px] md:bg-sky-100 rounded-3xl flex justify-center items-center">
                                        <img src={assets.mern} alt="" />
                                    </div>
                                    <img
                                        src={assets.person2}
                                        alt="User 2"
                                        className="absolute w-12 h-12 rounded-full border-2 border-white sm:bottom-0 sm:right-[30px] md:bottom-[-15px] md:right-[0px]"
                                    />
                                </div>
                            </div>
                            {/* photo-3  */}
                        ...
                        <div className="sm:pt-[30px]  md:w-[40%] lg:w-[35%]">
                            ...
                            <button className=" sm:mt-5 lg:mt-10 m-auto block border border- border-[#4000FF] hover:bg-[#4000FF] text-[#4000FF] hover:text-white transition ease-in-out  font-inter font-semibold w-[121px] h-[52px] rounded-xl">Sign Up</button>
                        </div>
                    </div>
                </Zoom>
            </Container>
